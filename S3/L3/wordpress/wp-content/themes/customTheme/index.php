...
<body class="is-preload">
    ...
    <!-- Scripts -->
    <script src="./wp-content/themes/customTheme/assets/js/jquery.min.js"></script>
    <script src="./wp-content/themes/customTheme/assets/js/browser.min.js"></script>
    <script src="./wp-content/themes/customTheme/assets/js/breakpoints.min.js"></script>
    <script src="./wp-content/themes/customTheme/assets/js/util.js"></script>
    <script src="./wp-content/themes/customTheme/assets/js/main.js"></script>
